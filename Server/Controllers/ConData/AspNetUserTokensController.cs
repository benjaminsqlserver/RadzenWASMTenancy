...
namespace RadzenSchoolTenants.Server.Controllers.ConData
{
    ...
    public partial class AspNetUserTokensController : ODataController
    {
        ...
        public AspNetUserTokensController(RadzenSchoolTenants.Server.Data.ConDataContext context)
        {
        ...
        public IEnumerable<RadzenSchoolTenants.Server.Models.ConData.AspNetUserToken> GetAspNetUserTokens()
        {
            var items = this.context.AspNetUserTokens.AsQueryable<RadzenSchoolTenants.Server.Models.ConData.AspNetUserToken>();
        ...
        partial void OnAspNetUserTokenGet(ref SingleResult<RadzenSchoolTenants.Server.Models.ConData.AspNetUserToken> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/ConData/AspNetUserTokens(UserId={keyUserId},LoginProvider={keyLoginProvider},Name={keyName})")]
        public SingleResult<RadzenSchoolTenants.Server.Models.ConData.AspNetUserToken> GetAspNetUserToken([FromODataUri] string keyUserId, [FromODataUri] string keyLoginProvider, [FromODataUri] string keyName)
        {
        ...
        public IActionResult DeleteAspNetUserToken([FromODataUri] string keyUserId, [FromODataUri] string keyLoginProvider, [FromODataUri] string keyName)
        {
            try
            {
                ...
                items = Data.EntityPatch.ApplyTo<RadzenSchoolTenants.Server.Models.ConData.AspNetUserToken>(Request, items);
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutAspNetUserToken([FromODataUri] string keyUserId, [FromODataUri] string keyLoginProvider, [FromODataUri] string keyName, [FromBody]RadzenSchoolTenants.Server.Models.ConData.AspNetUserToken item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchAspNetUserToken([FromODataUri] string keyUserId, [FromODataUri] string keyLoginProvider, [FromODataUri] string keyName, [FromBody]Delta<RadzenSchoolTenants.Server.Models.ConData.AspNetUserToken> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] RadzenSchoolTenants.Server.Models.ConData.AspNetUserToken item)
        {
            try
            {
                if(!ModelState.IsValid)
