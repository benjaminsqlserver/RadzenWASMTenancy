...
namespace RadzenSchoolTenants.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<RadzenSchoolTenants.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<RadzenSchoolTenants.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(RadzenSchoolTenants.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(RadzenSchoolTenants.Server.Models.ApplicationUser user)
        {
            try
            {
