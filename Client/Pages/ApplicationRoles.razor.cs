...
namespace RadzenSchoolTenants.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<RadzenSchoolTenants.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(RadzenSchoolTenants.Server.Models.ApplicationRole role)
        {
            try
            {
